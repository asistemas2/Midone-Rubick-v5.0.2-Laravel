...
@section('subhead')
    <title>Crear Categoría de Equipo - Parametrización ZFP</title>
@endsection

@section('subcontent')
    <div class="intro-y mt-8 flex items-center">
        <h2 class="mr-auto text-lg font-medium">Crear Nueva Categoría de Equipo</h2>
    </div>
    ...
    <div class="mt-5 grid grid-cols-12 gap-6">
        <div class="intro-y col-span-12 lg:col-span-6">
            <div class="intro-y box p-5">
                <form action="{{ route('parametrizacion.categorias_equipo.store') }}" method="POST">
                    @csrf
                    <div>
                    ...
                    <div class="mt-3">
                        ...
                        <x-base.form-textarea class="w-full @error('descripcion') border-danger @enderror" id="descripcion" name="descripcion" placeholder="Descripción de la categoría">{{ old('descripcion') }}</x-base.form-textarea>
