...
@section('subhead')
    <title>Editar Usuario - ZFP</title>
@endsection

@section('subcontent')
    <div class="intro-y mt-8 flex items-center">
        <h2 class="mr-auto text-lg font-medium">Editar Usuario: {{ $user->full_name }}</h2>
    </div>
                ...
                <form action="{{ route('gestion.usuarios.update', $user) }}" method="POST">
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <x-base.form-input class="w-full @error('first_name') border-danger @enderror" id="first_name" name="first_name" type="text" value="{{ old('first_name', $user->first_name) }}" required />
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <x-base.form-input class="w-full @error('last_name') border-danger @enderror" id="last_name" name="last_name" type="text" value="{{ old('last_name', $user->last_name) }}" required />
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <x-base.form-input class="w-full @error('email') border-danger @enderror" id="email" name="email" type="email" value="{{ old('email', $user->email) }}" required />
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <x-base.form-input class="w-full" id="position" name="position" type="text" value="{{ old('position', $user->position) }}" />
                        </div>
                        <div class="col-span-12 sm:col-span-6">
                            <x-base.form-label for="password">Contraseña</x-base.form-label>
                            <x-base.form-input class="w-full" id="password" name="password" type="password" placeholder="Dejar en blanco para no cambiar" />
                        </div>
                        <div class="col-span-12 sm:col-span-6">
                            <x-base.form-label for="password_confirmation">Confirmar Contraseña</x-base.form-label>
                            <x-base.form-input class="w-full" id="password_confirmation" name="password_confirmation" type="password" />
                        </div>
                        <div class="col-span-12 sm:col-span-6">
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <x-base.form-switch class="mt-2">
                                <x-base.form-switch.input type="checkbox" name="active" value="1" {{ old('active', $user->active) ? 'checked' : '' }} />
