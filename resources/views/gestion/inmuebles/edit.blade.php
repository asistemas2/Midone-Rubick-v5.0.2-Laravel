                ...
                <form action="{{ route('gestion.inmuebles.update', $inmueble) }}" method="POST">
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-12">
                            ...
                            @include('components.map-selector', ['latitud' => old('latitud', $inmueble->latitud ?? 3.55846), 'longitud' => old('longitud', $inmueble->longitud ?? -76.38627)])
                        </div>
                        <div class="col-span-12">
                    ...
                    <div id="fichaTecnicaContainer" class="mt-6" style="{{ $inmueble->tipoInmueble && $inmueble->tipoInmueble->nombre == 'Bodega' ? 'display: block;' : 'display: none;' }}">
                        <div class="border-b border-slate-200/60 pb-4 mb-4">
                        ...
                        <div class="grid grid-cols-12 gap-4 mb-4">
                            ...
                            <div class="col-span-12 sm:col-span-4">
                                ...
                                <x-base.form-input class="w-full" id="ficha_tecnica[area_calificada]" name="ficha_tecnica[area_calificada]" type="number" step="0.01" min="0" value="{{ old('ficha_tecnica.area_calificada', $inmueble->fichaTecnica->area_calificada ?? '') }}" />
                            </div>
                            <div class="col-span-12 sm:col-span-4">
                                <x-base.form-label for="ficha_tecnica[area_util]">Área Útil (m²)</x-base.form-label>
                                <x-base.form-input class="w-full" id="ficha_tecnica[area_util]" name="ficha_tecnica[area_util]" type="number" step="0.01" min="0" value="{{ old('ficha_tecnica.area_util', $inmueble->fichaTecnica->area_util ?? '') }}" />
                            </div>
                            <div class="col-span-12 sm:col-span-4">
                                <x-base.form-label for="ficha_tecnica[area_bruta]">Área Bruta (m²)</x-base.form-label>
                                <x-base.form-input class="w-full" id="ficha_tecnica[area_bruta]" name="ficha_tecnica[area_bruta]" type="number" step="0.01" min="0" value="{{ old('ficha_tecnica.area_bruta', $inmueble->fichaTecnica->area_bruta ?? '') }}" />
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-12 gap-4 mb-4">
                            ...
                            <div class="col-span-12 sm:col-span-4">
                                ...
                                <x-base.form-input class="w-full" id="ficha_tecnica[capacidad_electrica]" name="ficha_tecnica[capacidad_electrica]" type="text" value="{{ old('ficha_tecnica.capacidad_electrica', $inmueble->fichaTecnica->capacidad_electrica ?? '') }}" />
                            </div>
                            <div class="col-span-12 sm:col-span-4">
                                <x-base.form-label for="ficha_tecnica[agua_diametro]">Agua - Diámetro Acometida</x-base.form-label>
                                <x-base.form-input class="w-full" id="ficha_tecnica[agua_diametro]" name="ficha_tecnica[agua_diametro]" type="text" value="{{ old('ficha_tecnica.agua_diametro', $inmueble->fichaTecnica->agua_diametro ?? '') }}" />
                            </div>
                            <div class="col-span-12 sm:col-span-4">
                                <x-base.form-label for="ficha_tecnica[tuberia_aguas_lluvias]">Tubería Aguas Lluvias</x-base.form-label>
                                <x-base.form-input class="w-full" id="ficha_tecnica[tuberia_aguas_lluvias]" name="ficha_tecnica[tuberia_aguas_lluvias]" type="text" value="{{ old('ficha_tecnica.tuberia_aguas_lluvias', $inmueble->fichaTecnica->tuberia_aguas_lluvias ?? '') }}" />
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-12 gap-4 mb-4">
                            ...
                            <div class="col-span-12 sm:col-span-4">
                                ...
                                <x-base.form-input class="w-full" id="ficha_tecnica[cajas_inspeccion_pluvial]" name="ficha_tecnica[cajas_inspeccion_pluvial]" type="text" value="{{ old('ficha_tecnica.cajas_inspeccion_pluvial', $inmueble->fichaTecnica->cajas_inspeccion_pluvial ?? '') }}" />
                            </div>
                            <div class="col-span-12 sm:col-span-6">
                                <x-base.form-label for="ficha_tecnica[red_contra_incendios]">Red Contra Incendios</x-base.form-label>
                                <x-base.form-input class="w-full" id="ficha_tecnica[red_contra_incendios]" name="ficha_tecnica[red_contra_incendios]" type="text" value="{{ old('ficha_tecnica.red_contra_incendios', $inmueble->fichaTecnica->red_contra_incendios ?? '') }}" />
                            </div>
                            <div class="col-span-12 sm:col-span-2">
                                <x-base.form-label for="ficha_tecnica[gabinetes_ci]">Gabinetes C.I.</x-base.form-label>
                                <x-base.form-input class="w-full" id="ficha_tecnica[gabinetes_ci]" name="ficha_tecnica[gabinetes_ci]" type="number" min="0" value="{{ old('ficha_tecnica.gabinetes_ci', $inmueble->fichaTecnica->gabinetes_ci ?? '') }}" />
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-12 gap-4 mb-4">
                            ...
                            <div class="col-span-12">
                                ...
                                <x-base.form-textarea class="w-full" id="ficha_tecnica[cubierta]" name="ficha_tecnica[cubierta]" rows="2">{{ old('ficha_tecnica.cubierta', $inmueble->fichaTecnica->cubierta ?? '') }}</x-base.form-textarea>
                            </div>
                            <div class="col-span-12 sm:col-span-6">
                                <x-base.form-label for="ficha_tecnica[muros]">Muros</x-base.form-label>
                                <x-base.form-input class="w-full" id="ficha_tecnica[muros]" name="ficha_tecnica[muros]" type="text" value="{{ old('ficha_tecnica.muros', $inmueble->fichaTecnica->muros ?? '') }}" />
                            </div>
                            <div class="col-span-12 sm:col-span-6">
                                <x-base.form-label for="ficha_tecnica[acabados]">Acabados</x-base.form-label>
                                <x-base.form-input class="w-full" id="ficha_tecnica[acabados]" name="ficha_tecnica[acabados]" type="text" value="{{ old('ficha_tecnica.acabados', $inmueble->fichaTecnica->acabados ?? '') }}" />
                            </div>
                            <div class="col-span-12 sm:col-span-4">
                                <x-base.form-label for="ficha_tecnica[pisos]">Pisos</x-base.form-label>
                                <x-base.form-input class="w-full" id="ficha_tecnica[pisos]" name="ficha_tecnica[pisos]" type="text" value="{{ old('ficha_tecnica.pisos', $inmueble->fichaTecnica->pisos ?? '') }}" />
                            </div>
                            <div class="col-span-12 sm:col-span-4">
                                <x-base.form-label for="ficha_tecnica[blindaje_juntas]">Blindaje / Juntas</x-base.form-label>
                                <x-base.form-input class="w-full" id="ficha_tecnica[blindaje_juntas]" name="ficha_tecnica[blindaje_juntas]" type="text" value="{{ old('ficha_tecnica.blindaje_juntas', $inmueble->fichaTecnica->blindaje_juntas ?? '') }}" />
                            </div>
                            <div class="col-span-12 sm:col-span-4">
                                <x-base.form-label for="ficha_tecnica[estructura]">Estructura</x-base.form-label>
                                <x-base.form-input class="w-full" id="ficha_tecnica[estructura]" name="ficha_tecnica[estructura]" type="text" value="{{ old('ficha_tecnica.estructura', $inmueble->fichaTecnica->estructura ?? '') }}" />
                            </div>
                            <div class="col-span-12">
                                <x-base.form-label for="ficha_tecnica[puertas_ventanas]">Puertas y Ventanas</x-base.form-label>
                                <x-base.form-input class="w-full" id="ficha_tecnica[puertas_ventanas]" name="ficha_tecnica[puertas_ventanas]" type="text" value="{{ old('ficha_tecnica.puertas_ventanas', $inmueble->fichaTecnica->puertas_ventanas ?? '') }}" />
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-12 gap-4">
                            ...
                            <div class="col-span-12 sm:col-span-3">
                                <x-base.form-check>
                                    <x-base.form-check.input type="checkbox" id="ficha_tecnica_muelle" name="ficha_tecnica[muelle]" value="1" {{ old('ficha_tecnica.muelle', $inmueble->fichaTecnica->muelle ?? false) ? 'checked' : '' }} />
                                    <x-base.form-check.label for="ficha_tecnica_muelle">Muelle</x-base.form-check.label>
                                </x-base.form-check>
                            </div>
                            <div class="col-span-12 sm:col-span-3">
                                <x-base.form-check>
                                    <x-base.form-check.input type="checkbox" id="ficha_tecnica_mezzanine" name="ficha_tecnica[mezzanine]" value="1" {{ old('ficha_tecnica.mezzanine', $inmueble->fichaTecnica->mezzanine ?? false) ? 'checked' : '' }} />
                                    <x-base.form-check.label for="ficha_tecnica_mezzanine">Mezzanine</x-base.form-check.label>
                                </x-base.form-check>
                            </div>
                            <div class="col-span-12 sm:col-span-3">
                                <x-base.form-check>
                                    <x-base.form-check.input type="checkbox" id="ficha_tecnica_cocineta" name="ficha_tecnica[cocineta]" value="1" {{ old('ficha_tecnica.cocineta', $inmueble->fichaTecnica->cocineta ?? false) ? 'checked' : '' }} />
                            ...
                            <div class="col-span-12 sm:col-span-3">
                                ...
                                <x-base.form-input class="w-full" id="ficha_tecnica[bloques_banos]" name="ficha_tecnica[bloques_banos]" type="number" min="0" value="{{ old('ficha_tecnica.bloques_banos', $inmueble->fichaTecnica->bloques_banos ?? '') }}" placeholder="0" />
                            </div>
                        </div>
                    </div>
